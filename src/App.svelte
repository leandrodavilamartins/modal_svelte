<script>
  ...
  function createPDF() {
    let ingredientes = _.zip(item, quant);
    let formulaArray = [
      [
        {
...
<main>
    ...
    {#each todos as todo, index}
      <div class="form-line">
        <input
          ...
          bind:value={item[index]}
        />
        <input
          type="number"
          placeholder="Quantidade"
          bind:value={quant[index]}
        />
        <select bind:value={classe[index]}>
  ...
  <div>
    <br />
    <br />
    <button class="btn btn-warning" on:click={createPDF}
      ><svg
        xmlns="http://www.w3.org/2000/svg"
        width="30"
        height="30"
